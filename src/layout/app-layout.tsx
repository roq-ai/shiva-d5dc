...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'admin', 'customer-service-representative'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Expert', path: '/experts', entity: 'expert', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
