            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('expert', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>expert</Th>}
                ...
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('expert', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/experts/view/${record.expert?.id}`}>
                          {record.expert?.name}
                        </Link>
                      </Td>
                    )}
